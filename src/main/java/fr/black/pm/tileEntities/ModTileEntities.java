...
public class ModTileEntities {
    ...
    public static final RegistryObject<BlockEntityType<LightningChannelerTile>> LIGHTNING_CHANNELER_TILE =
            BLOCK_ENTITIES.register("lightning_channeler_tile", () -> BlockEntityType.Builder.of(
